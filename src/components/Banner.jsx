        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl font-black tracking-tight leading-[1.1] mb-6">
              Optimize Your <span className="text-primary">Business</span>{" "}
              Resources
            </h1>
            <p className="text-lg opacity-70 mb-10 max-w-xl mx-auto lg:mx-0">
              AssetFlow helps companies track, manage, and assign physical
              assets to employees with zero friction. Enhance accountability and
              reduce loss today.
            </p>
